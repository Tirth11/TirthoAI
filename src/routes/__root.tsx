...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://tirthoai.app/og-image.png" },
      { name: "twitter:image", content: "https://tirthoai.app/og-image.png" },
    ],
    links: [
      {
        rel: "stylesheet",
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "WebSite",
          name: "TirthoAI",
          url: "https://tirthoai.app",
          potentialAction: {
            "@type": "SearchAction",
            target: "https://tirthoai.app/?q={search_term_string}",
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          name: "TirthoAI",
          url: "https://tirthoai.app",
          logo: "https://tirthoai.app/favicon.ico",
        }),
      },
    ],
  }),
